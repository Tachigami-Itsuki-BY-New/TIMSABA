if mods[castra_mods] then
    ...
    is_castra_nickel = "is-castra-nickel"
    is_castra_recipe = "is-castra-recipe"
    is_castra_logistic = "is-castra-logistic"
    is_castra_building = "is-castra-building"
    is_castra_war = "is-castra-war"
    TIMSABA.functions.create_subgroups(ig_castra,
    {
        {name = is_castra_air,      order = a},
        {name = is_gunpowder,       order = b},
        {name = is_millerite,       order = c},
        {name = is_castra_nickel,   order = c_a},
