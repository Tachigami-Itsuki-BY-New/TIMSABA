if mods[castra_mods] then
    local graphics_castra = "__TIMSABA__/graphics/icons/castra/"
    ...
    ({
        {
            ...
            icon = graphics_castra .. castra_air .. ".png",
            order = a,
    ...
    ({
        {
            ...
            icon = graphics_castra .. potassium_nitrate .. ".png",
            order = h
        }
    })
    ...
    ({
        ...
        -- NITROGEN
        {
            ...
            icon = graphics_castra .. nitrosyl_chloride_gas .. ".png",
            order = y,
        ...
        -- SULFUR
        {
            ...
            icon = graphics_castra .. toluene_sulfur_solution .. ".png",
            order = h,
