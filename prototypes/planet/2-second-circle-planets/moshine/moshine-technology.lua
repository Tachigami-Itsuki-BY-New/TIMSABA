if mods[moshine_mods] then
    ...
    ({
        {
            localised_name = {"technology-name." .. tech_monazite_processing_1},
        ...
        {
            localised_name = {"technology-name." .. tech_monazite_processing_2},
        ...
        {
            localised_name = {"technology-name." .. tech_monazite_processing_3},
        ...
        {
            localised_name = {"technology-name." .. tech_monazite_processing_4},
    ...
    -- NEODYMIUM
    local graphics_neodymium_smelting_tech = "__TIMSABA__/graphics/icons/moshine/neodymium/technology/smelting-neodymium-tech.png"
    ...
    ({
        {
            localised_name = {"technology-name." .. tech_neodymium_smelting_1},
            localised_description = {"technology-description." .. tech_neodymium_smelting_1},
            type = technology,
        ...
        {
            localised_name = {"technology-name." .. tech_neodymium_smelting_2},
            localised_description = {"technology-description." .. tech_neodymium_smelting_2},
            type = technology,
        ...
        {
            localised_name = {"technology-name." .. tech_neodymium_smelting_3},
            localised_description = {"technology-description." .. tech_neodymium_smelting_3},
            type = technology,
