if mods[tellus_mods] then
    if settings.startup[setting_dye_secondary_color].value then
                ...
                ({
                    {
                        ...
                        icon = graphics_tellus .. color .. "-" .. pipe .. ".png",
                        icon_size = 64,
                        order = order,
                    ...
                    },
                    {
                        ...
                        icon = graphics_tellus .. color .. "-" .. pipe_to_ground .. ".png",
                        icon_size = 64,
                        order = order,
        ...
        if settings.startup[setting_dye_stone_path].value then
            ...
            local graphics_stone_path = "__TIMSABA__/graphics/terrain/stone-path/"
                ...
                ({
                    {
                        ...
                        variants =
                        {
                            ...
                            {
                                {
                                    picture = graphics_stone_path .. color .. "-stone-path/stone-path-1.png",
                                    count = 16,
                                    size = 1,
                                    scale = 0.5
                                },
                                {
                                    picture = graphics_stone_path .. color .. "-stone-path/stone-path-2.png",
                                    count = 16,
                                    size = 2,
                                    probability = 0.39,
                                    scale = 0.5
                                ...
                                {
                                    picture = graphics_stone_path .. color .. "-stone-path/stone-path-4.png",
                                    count = 16,
                                    size = 4,
                                    probability = 1,
                                    scale = 0.5
                            ...
                            transition =
                            {
                                overlay_layout =
                                {
                                    inner_corner =
                                    {
                                        spritesheet = graphics_stone_path .. color .. "-stone-path/stone-path-inner-corner.png",
                                        count = 16,
                                        tile_height = 2,
                                        scale = 0.5
                                    },
                                    outer_corner =
                                    {
                                        spritesheet = graphics_stone_path .. color .. "-stone-path/stone-path-outer-corner.png",
                                        count = 8,
                                        tile_height = 2,
                                        scale = 0.5
                                    },
                                    side =
                                    {
                                        spritesheet = graphics_stone_path .. color .. "-stone-path/stone-path-side.png",
                                        count = 16,
                                        tile_height = 2,
                                        scale = 0.5
                                    },
                                    u_transition =
                                    {
                                        spritesheet = graphics_stone_path .. color .. "-stone-path/stone-path-u.png",
                                        count = 8,
                                        tile_height = 2,
                                        scale = 0.5
                                    },
                                    o_transition =
                                    {
                                        spritesheet = graphics_stone_path .. color .. "-stone-path/stone-path-o.png",
                                        count = 4,
                                        scale = 0.5
                                    }
                                }
        ...
        if settings.startup[setting_dye_concrete].value then
            ...
            local graphics_concrete = "__TIMSABA__/graphics/terrain/concrete/"
                        ...
                        variants =
                        {
                            transition =
                            {
                                overlay_layout =
                                {
                                    inner_corner =
                                    {
                                        spritesheet = graphics_concrete .. color .. "/concrete-inner-corner.png",
                                        count = 16,
                                        scale = 0.5
                                    },
                                    outer_corner =
                                    {
                                        spritesheet = graphics_concrete .. color .. "/concrete-outer-corner.png",
                                        count = 8,
                                        scale = 0.5
                                    },
                                    side =
                                    {
                                        spritesheet = graphics_concrete .. color .. "/concrete-side.png",
                                        count = 16,
                                        scale = 0.5
                                    },
                                    u_transition =
                                    {
                                        spritesheet = graphics_concrete .. color .. "/concrete-u.png",
                                        count = 8,
                                        scale = 0.5
                                    },
                                    o_transition =
                                    {
                                        spritesheet = graphics_concrete .. color .. "/concrete-o.png",
                                        count = 4,
                                        scale = 0.5
                                    }
                                },
                            ...
                            material_background =
                            {
                                picture = graphics_concrete .. color .. "/concrete.png",
                                count = 8,
                                scale = 0.5
                            }
                        },
        ...
        if settings.startup[setting_dye_hazard_concrete].value then
            ...
            local graphics_hazard = "__TIMSABA__/graphics/terrain/hazard/"
                ...
                ({
                    {
                        ...
                        variants =
                        {
                            ...
                            material_background =
                            {
                                picture = graphics_hazard .. color .. "/hazard-concrete-left.png",
                                count = 8,
                                scale = 0.5
                            }
                        },
                    ...
                    },
                    {
                        ...
                        variants =
                        {
                            ...
                            material_background =
                            {
                                picture = graphics_hazard .. color .. "/hazard-concrete-right.png",
                                count = 8,
                                scale = 0.5
                            }
                        },
                ...
                ({
                    {
                        ...
                        variants =
                        {
                            ...
                            material_background =
                            {
                                picture = graphics_hazard .. color .. "/reinforced-hazard-concrete-left.png",
                                count = 8,
                                scale = 0.5
                            }
                        },
                    ...
                    },
                    {
                        ...
                        variants =
                        {
                            ...
                            material_background =
                            {
                                picture = graphics_hazard .. color .. "/reinforced-hazard-concrete-right.png",
                                count = 8,
                                scale = 0.5
                            }
                        },
        ...
        if settings.startup[setting_dye_stone_wall].value then
            ...
            local graphics_wall = "__TIMSABA__/graphics/entity/wall/"
                ...
                ({
                    {
                        ...
                        icon = graphics_tellus .. color .. "-stone-wall.png",
                        flags = {"placeable-neutral", "player-creation"},
                        collision_box = {{-0.29, -0.29}, {0.29, 0.29}},
                        selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
                        ...
                        pictures =
                        {
                            single =
                            {
                                ...
                                {
                                    {
                                        filename = graphics_wall .. color .. "/wall-single.png",
                                        priority = extra_high,
                                        width = 64,
                                        height = 86,
                                        variation_count = 2,
                            ...
                            straight_vertical =
                            {
                                ...
                                {
                                    {
                                        filename = graphics_wall .. color .. "/wall-vertical.png",
                                        priority = extra_high,
                                        width = 64,
                                        height = 134,
                                        variation_count = 5,
                            ...
                            straight_horizontal =
                            {
                                ...
                                {
                                    {
                                        filename = graphics_wall .. color .. "/wall-horizontal.png",
                                        priority = extra_high,
                                        width = 64,
                                        height = 92,
                                        variation_count = 6,
                            ...
                            corner_right_down =
                            {
                                ...
                                {
                                    {
                                        filename = graphics_wall .. color .. "/wall-corner-right.png",
                                        priority = extra_high,
                                        width = 64,
                                        height = 128,
                                        variation_count = 2,
                            ...
                            corner_left_down =
                            {
                                ...
                                {
                                    {
                                        filename = graphics_wall .. color .. "/wall-corner-left.png",
                                        priority = extra_high,
                                        width = 64,
                                        height = 134,
                                        variation_count = 2,
                            ...
                            t_up =
                            {
                                ...
                                {
                                    {
                                        filename = graphics_wall .. color .. "/wall-t.png",
                                        priority = extra_high,
                                        width = 64,
                                        height = 134,
                                        variation_count = 4,
                            ...
                            ending_right =
                            {
                                ...
                                {
                                    {
                                        filename = graphics_wall .. color .. "/wall-ending-right.png",
                                        priority = extra_high,
                                        width = 64,
                                        height = 92,
                                        variation_count = 2,
                            ...
                            ending_left =
                            {
                                ...
                                {
                                    {
                                        filename = graphics_wall .. color .. "/wall-ending-left.png",
                                        priority = extra_high,
                                        width = 64,
                                        height = 92,
                                        variation_count = 2,
                            ...
                            filling =
                            {
                                filename = graphics_wall .. color .. "/wall-filling.png",
                                priority = extra_high,
                                width = 48,
                                height = 56,
                                variation_count = 8,
                            ...
                            water_connection_patch =
                            {
                                ...
                                {
                                    {
                                        filename = graphics_wall .. color .. "/wall-patch.png",
                                        priority = extra_high,
                                        width = 116,
                                        height = 128,
                                        shift = util.by_pixel(0, -2),
    ...
    local function copyGrid(name, tile_data, colored_concrete)
        ...
        local graphics_tutorial_grid = "__TIMSABA__/graphics/terrain/tutorial-grid/"

        grid.variants.main[1].picture = graphics_tutorial_grid .. color_name .. "/tutorial-grid1.png"
        grid.variants.main[2].picture = graphics_tutorial_grid .. color_name .. "/tutorial-grid2.png"

        local overlay = grid.variants.transition.overlay_layout
        overlay.inner_corner.spritesheet = graphics_tutorial_grid .. color_name .. "/tutorial-grid-inner-corner.png"
        overlay.outer_corner.spritesheet = graphics_tutorial_grid .. color_name .. "/tutorial-grid-outer-corner.png"
        overlay.side.spritesheet = graphics_tutorial_grid .. color_name .. "/tutorial-grid-side.png"
        overlay.u_transition.spritesheet = graphics_tutorial_grid .. color_name .. "/tutorial-grid-u.png"
        overlay.o_transition.spritesheet = graphics_tutorial_grid .. color_name .. "/tutorial-grid-o.png"
