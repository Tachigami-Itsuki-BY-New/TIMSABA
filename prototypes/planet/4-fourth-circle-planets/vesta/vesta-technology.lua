if mods[vesta_mods] then
    ...
    local graphics_iridium_smelting_tech = "__TIMSABA__/graphics/icons/vesta/iridium/technology/smelting-iridium-tech.png"
    ...
    ({
        {
            localised_name = {"technology-name." .. tech_iridium_smelting_1},
            localised_description = {"technology-description." .. tech_iridium_smelting_1},
            type = technology,
            name = tech_iridium_smelting_1,
            icon = graphics_iridium_smelting_tech,
            icon_size = 256,
        ...
        },
        {
            ...
            localised_description = {"technology-description." .. tech_iridium_smelting_2},
            type = technology,
        ...
        {
            localised_name = {"technology-name." .. tech_iridium_smelting_3},
            localised_description = {"technology-description." .. tech_iridium_smelting_3},
            type = technology,
