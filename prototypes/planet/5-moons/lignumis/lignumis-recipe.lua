if mods[lignumis_mods] then
    ...
    sortiong_ore_recipe_false(brannerite_ore, l)
    sortiong_ore_recipe_false(antimonite_ore, m)
    sortiong_ore_recipe_false(germanite_ore, n)
    if mods[moshine_mods] then
        sortiong_ore_recipe_false(monazite_ore, o)
    end
    if mods[corrundum_mods] then
        sortiong_ore_recipe_false(chalcopyrite_ore, p)
    end
    if mods[castra_mods] then
        sortiong_ore_recipe_false(millerite_ore, q)
    end
    if mods[paracelsin_mods] then
        sortiong_ore_recipe_false(sphalerite_ore, r)
        sortiong_ore_recipe_false(tetrahedrite_ore, s)
    end
end