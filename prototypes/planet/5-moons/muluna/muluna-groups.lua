if mods[muluna_mods] then
    ...
    is_muluna_recipe_jellynut = "is-muluna-recipe-jellynut"
    is_muluna_recipe_yumako = "is-muluna-recipe-yumako"
    ...
    TIMSABA.functions.create_subgroups(ig_muluna,
    {
        ...
        {name = is_muluna_recipe_jellynut,                  order = d_a},
        {name = is_muluna_recipe_yumako,                    order = d_b},
