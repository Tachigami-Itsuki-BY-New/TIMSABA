if mods[aegis_bellicos_mods] then
    ...
    local graphics_beryllium_smelting_tech = "__TIMSABA__/graphics/icons/bellicos-and-aegis/beryllium/technology/smelting-beryllium-tech.png"
    ...
    local graphics_beryllium_bronze_smelting_tech = "__TIMSABA__/graphics/icons/bellicos-and-aegis/beryllium/technology/smelting-beryllium-bronze-tech.png"
    ...
    ({
        {
            localised_name = {"technology-name." .. tech_beryllium_smelting_1},
            localised_description = {"technology-description." .. tech_beryllium_smelting_1},
            type = technology,
            name = tech_beryllium_smelting_1,
            icon = graphics_beryllium_smelting_tech,
            icon_size = 256,
        ...
        {
            localised_name = {"technology-name." .. tech_beryllium_smelting_2},
            localised_description = {"technology-description." .. tech_beryllium_smelting_2},
            type = technology,
        ...
        {
            localised_name = {"technology-name." .. tech_beryllium_smelting_3},
            localised_description = {"technology-description." .. tech_beryllium_smelting_3},
            type = technology,
        ...
        {
            localised_name = {"technology-name." .. tech_beryllium_bronze_smelting_1},
            localised_description = {"technology-description." .. tech_beryllium_bronze_smelting_1},
            type = technology,
            name = tech_beryllium_bronze_smelting_1,
            icon = graphics_beryllium_bronze_smelting_tech,
            icon_size = 256,
        ...
        {
            localised_name = {"technology-name." .. tech_beryllium_bronze_smelting_2},
            localised_description = {"technology-description." .. tech_beryllium_bronze_smelting_2},
            type = technology,
        ...
        },
        {
            ...
            icon = "__TIMSABA__/graphics/icons/bellicos-and-aegis/beryllium/" .. beryllium_bronze_plate .. ".png",
