...
-- GALIUM
local graphics_gallium_smelting_tech = "__TIMSABA__/graphics/icons/space-age/aquilo/technology/smelting-gallium-tech.png"
tech_gallium_smelting_1 = "gallium-smelting-1"
tech_gallium_smelting_2 = "gallium-smelting-2"
tech_gallium_smelting_3 = "gallium-smelting-3"
data:extend
({
    {
        localised_name = {"technology-name." .. tech_gallium_smelting_1},
        localised_description = {"technology-description." .. tech_gallium_smelting_1},
        type = technology,
        ...
        effects =
        {
            ...
            {type = unlock_recipe, recipe = gallium_oxide_III},
            {type = unlock_recipe, recipe = sodium_tetrahydroxogallate_III_solution},
            {type = unlock_recipe, recipe = gallium_liquid},
            {type = unlock_recipe, recipe = gallium_ingot},
            {type = unlock_recipe, recipe = gallium_powder}
        },
        unit =
        {
            count = 200,
    ...
    {
        localised_name = {"technology-name." .. tech_gallium_smelting_2},
        localised_description = {"technology-description." .. tech_gallium_smelting_2},
        type = technology,
        ...
        effects =
        {
            ...
            {type = unlock_recipe, recipe = gallium_chloride_III},
            {type = unlock_recipe, recipe = gallium_chloride_III_solution_ether},
            {type = unlock_recipe, recipe = lithium_gallium_hydride_solution_ether},
            {type = unlock_recipe, recipe = gallium_hydroxide_III_2}
        },
        unit =
        {
            count = 200,
    ...
    {
        localised_name = {"technology-name." .. tech_gallium_smelting_3},
        localised_description = {"technology-description." .. tech_gallium_smelting_3},
        type = technology,
...
({
    -- ARSENIC
    {
        ...
        icons = TIMSABA.functions.create_gas_tech_icon("AsAsAs"),
    ...
    -- AQUILO
    {
        ...
        icon_size = 256,
        prerequisites = {tech_arsenic_processing, tech_gallium_smelting_1},
        effects =
        {
            {type = unlock_recipe, recipe = gallium_arsenide},
            {type = unlock_recipe, recipe = gallium_nitride},
